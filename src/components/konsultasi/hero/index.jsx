  ...
  return (
    <div className="konsultasi-hero">
      <div className="deskripsi">
        ...
        <p>
          Di sini, Anda dapat langsung berkomunikasi dengan para dokter
          profesional yang ahli di bidangnya, dengan harapan Anda dapat
          menemukan solusi terbaik untuk perjalanan pemulihan Anda
        </p>
