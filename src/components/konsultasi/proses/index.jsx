    ...
    <div className="konsultasi-left">
      <div className="konsultasi-left-body">
        ...
        <div className="konsultasi-users">
          {users
            .filter((user) =>
              user.user.username.toLowerCase().includes(q.toLowerCase())
            )
            .map((user) => (
              <div
                onClick={() => {
              ...
              >
                ...
                {user.unread > 0 && (
                  <div className="konsultasi-count-new-message">
                    {user.unread}
                  </div>
                )}
              </div>
...
function Conversation({ user, messages, sendMessage, closePath }) {
  return (
    <div className="konsultasi-center">
      <ConversationHeader
        avatar={user.avatar || brand}
        username={user.username || "AdaChat"}
        to={closePath}
      />
...
export { Container, SideBar, Conversation };
